...
const createDefaultWorks = (defaultWorks) => {
  ...
  imgDesk.classList.add('imgalin', 'imgdesk'+parseInt(defaultWorks.dataset+1));
  imgDiv.appendChild(imgDesk);

  const imgMob = createElement('img');
  imgMob.src = defaultWorks.imgmob;
  imgMob.classList.add('imgalin', 'imgmob'+parseInt(defaultWorks.dataset+1));
...
function windowModal(e) {
  ...
  cardContainter.appendChild(defaultWorksTitle);
  ...
  imgDesk.classList.add('imgalin', 'imgdesk'+parseInt(projectCardInfo.dataset+1));
  imgDiv.appendChild(imgDesk);

  const imgMob = createElement('img');
  imgMob.src = projectCardInfo.imgmob;
  imgMob.classList.add('imgalin', 'imgmob'+parseInt(projectCardInfo.dataset+1));
  imgDiv.appendChild(imgMob);
  ...
  subSectionDiv.appendChild(popupLinkContainer);
  ...
  cardContainter.appendChild(projectPopup);
  bodyTag.appendChild(cardContainter);
  ...
  closeBtn.addEventListener('click', () => {
    bodyTag.removeChild(cardContainter);
